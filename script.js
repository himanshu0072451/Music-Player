...
mainPhone.addEventListener("click", function () {
  console.log("mainPhone clicked"); // Check if this message appears in the console
  if (flag == 0) {
    mainPhone.innerHTML = `<i class="ri-pause-mini-fill"></i>`;
    audio.play();
    flag = 1;
...
main.addEventListener("click", function () {
  console.log("Main clicked"); // Check if this message appears in the console
  if (count == 0) {
    main.innerHTML = `<i class="ri-pause-mini-fill"></i>`;
    audio.play();
    count = 1;
